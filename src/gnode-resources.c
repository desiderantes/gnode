...
static const SECTION union { const guint8 data[6090]; const double alignment; void * const ptr;}  gnode_resource_data = { {
  ...
  0xca, 0x17, 0x00, 0x00, 0x75, 0x69, 0x2f, 0x00, 
  ...
  0x72, 0x3d, 0x22, 0x67, 0x6e, 0x6f, 0x64, 0x65, 
